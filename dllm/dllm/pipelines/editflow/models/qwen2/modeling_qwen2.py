...
class EditFlowQwen2Config(a2d.A2DQwen2Config):
    model_type = "editflow-qwen2"  # <- NEW model_type


class EditFlowQwen2Model(a2d.A2DQwen2LMHeadModel):
    config_class = EditFlowQwen2Config
    modules_to_save = {
        "rate_heads",
        "sub_logits",
        "ins_logits",
...
AutoConfig.register("editflow-qwen2", EditFlowQwen2Config)
AutoModel.register(EditFlowQwen2Config, EditFlowQwen2Model)
...
if __name__ == "__main__":
    ...
    config = EditFlowQwen2Config.from_pretrained(config_path)
    ...
    model = EditFlowQwen2Model(config)
    model.save_pretrained("models-tmp/editflow-qwen2")
    auto_model = AutoModel.from_pretrained("models-tmp/editflow-qwen2")
