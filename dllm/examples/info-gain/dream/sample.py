"""
python -u examples/info-gain/dream/sample.py --model_name_or_path "YOUR_MODEL_PATH"
"""
...
@dataclass
class SamplerConfig(dllm.pipelines.info_gain.dream.InfoGainDreamSamplerConfig):
    steps: int = 512
...
infogain_config = dllm.pipelines.info_gain.dream.InfoGainDreamConfig.from_pretrained(
...
sampler = dllm.pipelines.info_gain.dream.InfoGainDreamSampler(
...
print("\n" + "=" * 80)
print("TEST: info-gain dream.sample()".center(80))
print("=" * 80)
